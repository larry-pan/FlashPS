...
def main():
    ...
    p.add_argument("--mask", default=None, help="custom mask PNG (white=swap). Overrides --mask-box")
    p.add_argument("--mask-box", default="0.30,0.16,0.70,0.62",
                   help="torso box as left,top,right,bottom fractions of the image (white=regenerate). "
    ...
    p.add_argument("--edit-strength", type=float, default=0.9)
